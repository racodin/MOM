...
import browser from './static/browser';
import isMobile from './static/isMobile';
import each from './static/each';
import addClass from './instance/addClass';
import removeClass from './instance/removeClass';
import toggleClass from './instance/toggleClass';
import hasClass from './instance/hasClass';
